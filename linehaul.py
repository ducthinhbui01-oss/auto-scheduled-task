...
def run():
    ...
    try:
        with sync_playwright() as p:
            ...
            # Click nút Đăng nhập và nhấn Enter
            ...
            # --- CHỜ MÁY CHỦ CẤP ĐÚNG TOKEN fms_user_id ---
            print("-> Đang chờ máy chủ xác thực tài khoản và cấp mã định danh...")
            cookie_dict = {}
            user_id = ""
            user_key = ""
            ...
            if not user_id:
                print("⚠️ Cảnh báo: Đăng nhập chưa nhận được User ID. Vui lòng kiểm tra lại USERNAME/PASSWORD trong Secrets.")
            ...
            # Cấu hình Headers cho Python Requests
            req_headers = {
                "app": "FMS Portal",
